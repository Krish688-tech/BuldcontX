...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/buldcontx/",
    icon: Instagram,
  },
  {
    label: "Facebook",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/palani-ganesan-b27a903a/",
    icon: Linkedin,
  },
  { label: "X", href: "https://x.com/buldcontx", icon: "x" },
  {
    label: "YouTube",
    href: "https://www.youtube.com/@BuldContx",
    icon: Youtube,
  },
];
...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative overflow-hidden bg-[#0b1820] px-5 pb-6 pt-24 text-white sm:px-8 lg:px-16 lg:pt-32"
    >
      {/* ARCHITECTURAL GRID */}

      <div
        ref={gridRef}
        className="pointer-events-none absolute inset-0 opacity-[0.07] bg-[linear-gradient(rgba(109,166,194,.7)_1px,transparent_1px),linear-gradient(90deg,rgba(109,166,194,.7)_1px,transparent_1px)] bg-size-[65px_65px]"
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="footer-navigation grid gap-12 py-12 sm:grid-cols-2 lg:grid-cols-[1fr_.6fr_.6fr]">
          ...
          <div className="footer-item">
            ...
            <div className="mt-6 space-y-3">
              ...
              <a
                href="mailto:hello@buldcontx.com"
                className="block text-sm text-white/50 transition-colors hover:text-white"
              >
                buldcontx@gmail.com
              </a>

              <p className="text-sm text-white/50">Tamil Nadu, India</p>
            </div>
        ...
        <div className="flex flex-col justify-between gap-3 py-7 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-5">
            <a
              href="#"
              className="font-mono text-[8px] uppercase tracking-[0.2em] text-white/25 transition-colors hover:text-white/60"
            >
              Privacy
            </a>
